...
function VerifyEmailContent({ from }: { from: 'signup' | 'login' }) {
...
// get nextjs page props, determine if the user came from signup or login
export default function VerifyEmailPage() {
	const [from, setFrom] = useQueryState<'login' | 'signup'>('from', parseAsStringLiteral(['login', 'signup']).withDefault('signup'));
