...
const Slider = React.forwardRef<React.ElementRef<typeof SliderPrimitive.Root>, SliderProps>(({ className, borderPrimary, ...props }, ref) => (
	<SliderPrimitive.Root ref={ref} className={cn('relative flex w-full touch-none select-none items-center', className)} {...props}>
		...
		<SliderPrimitive.Thumb
			className={cn(
				...
				borderPrimary ? 'border-primary' : 'border-accent-foreground',
			)}
		/>
