...
export async function SectionCards() {
	...
	const incomeLastMonth = ordersLastMonth.docs.reduce((total: number, order) => total + (order.total || 0), 0);
	const lifetimeIncome = orders.docs.reduce((total: number, order) => total + (order.total || 0), 0);
